...
$sql_busca_credito_restante = "SELECT * FROM login WHERE email = '$emailCliente'";
$query = mysqli_query($conn, $sql_busca_credito_restante);

while($rows_usuarios = mysqli_fetch_array($query)) {
    $creditos_login = $rows_usuarios['creditos'];
}   
        
$creditos1 = $creditos + $creditos_login;
