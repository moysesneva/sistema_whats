...
while ($rows_usuarios = mysqli_fetch_array($query)) {
    ...
    $barra_icon  = $rows_usuarios['barra_logo'];
    $barra_cima = $rows_usuarios['barra_principal'];
    $menu_cor = $rows_usuarios['menu_trasnparencia'];
    $selecao_menu = $rows_usuarios['cor_selecao_menu'];
    $tema = $rows_usuarios['tema_menu'];
    ...
    var PcodedMenu = {
        ...
        HandleThemeBackground: function() {
            ...
            function setlheadertheme() {
                if (tema_lateral != undefined && tema_lateral != "") {
                    $('#' + oid + ' .pcoded-header .navbar-logo').attr("logo-theme", tema_lateral);
