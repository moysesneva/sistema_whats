...
<head>
    ...
    <title>Gerenciar Mensagens do Chatbot</title>
    ...
    <style>
        ...
        .section-card.welcome { border-left-color: var(--info-color); }
        .section-card.prompt { border-left-color: var(--success-color); }
        .section-card.farewell { border-left-color: var(--danger-color); }
        .section-card.settings { border-left-color: var(--warning-color); }
