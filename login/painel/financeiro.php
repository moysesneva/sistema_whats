...
<div class="row">
    <div class="col-md-3">
        <div class="card bg-c-green order-card">
            <div class="card-block">
                <h6 class="m-b-20">Serviço Mais Vendido</h6>
                <h2 class="text-right">
                    <i class="feather icon-trending-up f-left"></i>
                    <span><?=$servico_mais_vendido['vendas']?></span>
                </h2>
                <p class="m-b-0"><?=htmlspecialchars($servico_mais_vendido['nome'], ENT_QUOTES, 'UTF-8')?></p>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card bg-c-blue order-card">
            <div class="card-block">
                <h6 class="m-b-20">Faturamento do Top Serviço</h6>
                <h2 class="text-right">
                    <i class="feather icon-dollar-sign f-left"></i>
                    <span>R$ <?=number_format($servico_mais_vendido['faturamento'], 2, ',', '.')?></span>
                </h2>
                <p class="m-b-0">Período analisado</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card bg-c-yellow order-card">
            <div class="card-block">
                <h6 class="m-b-20">Serviço Menos Vendido</h6>
                <h2 class="text-right">
                    <i class="feather icon-trending-down f-left"></i>
                    <span><?=$servico_menos_vendido['vendas']?></span>
                </h2>
                <p class="m-b-0"><?=htmlspecialchars($servico_menos_vendido['nome'], ENT_QUOTES, 'UTF-8')?></p>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card bg-c-pink order-card">
            <div class="card-block">
                <h6 class="m-b-20">Total de Serviços</h6>
                <h2 class="text-right">
                    <i class="feather icon-grid f-left"></i>
                    <span><?=count($servicos_vendidos)?></span>
                </h2>
                <p class="m-b-0">Cadastrados e ativos</p>
            </div>
        </div>
    </div>
</div>
