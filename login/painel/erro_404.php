...
<head>
    ...
    <title>Página Não Encontrada — MoysesNet</title>
    <style>
        ...
        <div class="card-header">
            <div class="icon" aria-hidden="true">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M9 9l6 6M15 9l-6 6" stroke="#fff" stroke-width="2.2" stroke-linecap="round"/>
                </svg>
            </div>
            <div>
                <h1>Página Não Encontrada</h1>
                <p>Erro 404 — o endereço solicitado não existe</p>
            </div>
        </div>
        <div class="card-body">
            <p>
            ...
            <div class="steps">
                ...
                <ul>
                    ...
                    <li>Acesse a página inicial pelo botão abaixo</li>
                </ul>
            </div>
        </div>
