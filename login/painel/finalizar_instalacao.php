...
$webhook_recebe = '/login/painel/api/recebe.php';
$webhook_envia = '/login/painel/api/envia.php';
$webhook_confirma = '/login/painel/api/confirma.php';
$webhook_recebe = $webhook . $webhook_recebe;
$webhook_envia = $webhook . $webhook_envia;
$webhook_confirma = $webhook . $webhook_confirma;

$webhook_recebe = barra($webhook_recebe);
$webhook_envia = barra($webhook_envia);
$webhook_confirma = barra($webhook_confirma);



$usuario_api = So_numeros($login);
$usuario_api = $termo . $usuario_api;

# Correção das aspas no WHERE
$sql_login = "UPDATE login SET tipo = '1', usuario_api = '$usuario_api',situacao = 'ativado' WHERE login='$login'";
$query_login = mysqli_query($conn, $sql_login);




 // Define a consulta SQL para atualização
$sql_config = "UPDATE config SET servidor_recebe = '$webhook_recebe', servidor_envia = '$webhook_envia', servidor_confirma = '$webhook_confirma'";

// Executa a consulta
$query_login2 = mysqli_query($conn, $sql_config);
...
if($query){
 ...
 #VaiPara('config_adm.php?confirmacao=atualizado'); 
