...
<head>
    ...
    <title>Erro Inesperado — MoysesNet</title>
    <style>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div>
                ...
                <p>Não se preocupe, sua informação está segura</p>
            </div>
        </div>
        <div class="card-body">
            <p>
                Algo inesperado aconteceu no sistema. O erro foi registrado
                automaticamente e nossa equipe será notificada.
            </p>
            <div class="steps">
